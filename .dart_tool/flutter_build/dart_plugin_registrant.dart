...
import 'package:dyte_core_android/dyte_core_android.dart';
...
import 'package:dyte_core_ios/dyte_core_ios.dart';
...
class _PluginRegistrant {
  ...
  static void register() {
    if (Platform.isAndroid) {
      try {
        FlutterCoreAndroid.registerWith();
      } catch (err) {
        print(
          '`dyte_core_android` threw an error: $err. '
      ...
      try {
        FlutterCoreIOS.registerWith();
      } catch (err) {
        print(
          '`dyte_core_ios` threw an error: $err. '
          'The app may not function as expected until you remove this plugin from pubspec.yaml'
        );
      }

...
class GeolocatorWidgetState extends State<GeolocatorWidget> {
  ...
  FieldEngineerModel engineer = FieldEngineerModel();

  @override
  void initState() {
    super.initState();
    _toggleServiceStatusStream();
    engineer = FieldEngineerModel(email: "vinay");
    insertRecordInFEForLocation(engineer);
  }
  ...
  Widget getPage() {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("FE Location Demo"),
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          if (positionItem.type == _PositionItemType.log) {
            ...
            return Card(
              child: ListTile(
                tileColor: AppColors.themeMaterialColor,
                title: Text(
      ...
      floatingActionButton: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Text(
              "Press play button, the Latitude & Longitude will start to get listed above",
  ...
  void _updatePositionList(_PositionItemType type, String displayValue) {
    ...
    //  updateRecordInFEForLocation(engineer);
    setState(() {});
  }

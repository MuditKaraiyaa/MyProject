...
class DatabaseService {
  ...
  Future updateGroupForUser(String groupName, String groupId, String userName) async {
    DocumentReference userDocumentReference = userCollection.doc(uid);
    DocumentSnapshot documentSnapshot = await userDocumentReference.get();
  ...
  // Future sendPushNotification(List<String> tokens, String message) async {
  ...
  //     "messageTitle": Constants.appName,
  //     "messageBody": message
  //   });

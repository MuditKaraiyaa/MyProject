...
class CSRPdfPage extends StatelessWidget {
  const CSRPdfPage({
    super.key,
    required this.model,
  });
  ...
  String formatDate(String? dateTime) {
    ...
    try {
      ...
      // Handle the exception if the date-time string is not in a valid format  h
      return '';
    }
  }
          ...
          children: [
            ...
            pw.Column(
              ...
              children: [
                ...
                pw.Text(
                  "${model.cstRefID != null && model.cstRefID!.isNotEmpty ? model.cstRefID : '__'}  ",
                  style: pw.TextStyle(
                    fontSize: 7.sp,
                    color: model.cstRefID != null && model.cstRefID!.isNotEmpty
                        ? null
                        : PdfColors.white,
                    fontWeight: pw.FontWeight.bold,
                  ),
